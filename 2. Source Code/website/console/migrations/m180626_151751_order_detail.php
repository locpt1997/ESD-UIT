...
/**
 * Class m180626_151751_order_detail
 */
class m180626_151751_order_detail extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    public function up()
    {
        ...
        $this->addForeignKey('fk_orderdetail_order','order_detail','orderid','order','id');
