...
class WebClient { 
    ...
    protected $_url;
    protected $_header = array("cache-control: no-cache",
    "content-type: application/x-www-form-urlencoded",
    "postman-token: c8439738-15d0-b34f-05df-616665053066");
    ...
    { 
       ...
       $removeBom = function($var) { return preg_replace('/\\0/', "", $var); };
        ...
        curl_setopt($s,CURLOPT_URL,$removeBom($this->_url)); 
        curl_setopt($s,CURLOPT_HTTPHEADER, $removeBom($this->_header)); 
